...
public class Route implements Serializable {
    ...
    public Route(String name, List<Waypoint> waypoints, boolean isFinished, int progression, boolean hasStarted) {
        ...
        this.imgLink="https://images.unsplash.com/photo-1483213097419-365e22f0f258?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1350&q=80";
